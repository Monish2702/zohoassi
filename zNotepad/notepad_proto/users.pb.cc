...
PROTOBUF_CONSTEXPR project::project(
  ...
  , /*decltype(_impl_.project_content_)*/{&::_pbi::fixed_address_empty_string, ::_pbi::ConstantInitialized{}}
...
static ::_pb::Metadata file_level_metadata_users_2eproto[4];
...
const uint32_t TableStruct_users_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::notepad_users::project, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::notepad_users::project, _impl_.project_id_),
  PROTOBUF_FIELD_OFFSET(::notepad_users::project, _impl_.user_id_),
  PROTOBUF_FIELD_OFFSET(::notepad_users::project, _impl_.project_name_),
  PROTOBUF_FIELD_OFFSET(::notepad_users::project, _impl_.project_content_),
  ~0u,  // no _has_bits_
  PROTOBUF_FIELD_OFFSET(::notepad_users::project_list, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::notepad_users::project_list, _impl_.projects_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::notepad_users::User)},
  { 10, -1, -1, sizeof(::notepad_users::UserList)},
  { 17, -1, -1, sizeof(::notepad_users::project)},
  { 27, -1, -1, sizeof(::notepad_users::project_list)},
};

static const ::_pb::Message* const file_default_instances[] = {
  &::notepad_users::_User_default_instance_._instance,
  &::notepad_users::_UserList_default_instance_._instance,
  &::notepad_users::_project_default_instance_._instance,
  &::notepad_users::_project_list_default_instance_._instance,
};
...
const char descriptor_table_protodef_users_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "(\0132\023.notepad_users.User\"]\n\007project\022\022\n\npr"
  "oject_id\030\001 \001(\005\022\017\n\007user_id\030\002 \001(\005\022\024\n\014proje"
  "ct_name\030\003 \001(\t\022\027\n\017project_content\030\004 \001(\t\"8"
  "\n\014project_list\022(\n\010projects\030\001 \003(\0132\026.notep"
  "ad_users.projectb\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_users_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_users_2eproto = {
    false, false, 304, descriptor_table_protodef_users_2eproto,
    "users.proto",
    &descriptor_table_users_2eproto_once, nullptr, 0, 4,
...
project::project(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:notepad_users.project)
}
project::project(const project& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.project_content_){}
  ...
  _impl_.project_content_.InitDefault();
  #ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
    _impl_.project_content_.Set("", GetArenaForAllocation());
  #endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  if (!from._internal_project_content().empty()) {
    _this->_impl_.project_content_.Set(from._internal_project_content(), 
      _this->GetArenaForAllocation());
  }
  ...
  // @@protoc_insertion_point(copy_constructor:notepad_users.project)
}
...
project::~project() {
  // @@protoc_insertion_point(destructor:notepad_users.project)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
inline void project::SharedDtor() {
  ...
  _impl_.project_content_.Destroy();
}
...
void project::Clear() {
// @@protoc_insertion_point(message_clear_start:notepad_users.project)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "notepad_users.project.project_name"));
        } else
          goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 34)) {
          auto str = _internal_mutable_project_content();
          ptr = ::_pbi::InlineGreedyStringParser(str, ptr, ctx);
          CHK_(ptr);
          CHK_(::_pbi::VerifyUTF8(str, "notepad_users.project.project_content"));
        } else
          goto handle_unusual;
        continue;
      default:
...
uint8_t* project::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:notepad_users.project)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!this->_internal_project_name().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      ...
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "notepad_users.project.project_name");
    target = stream->WriteStringMaybeAliased(
        3, this->_internal_project_name(), target);
  }

  // string project_content = 4;
  if (!this->_internal_project_content().empty()) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::VerifyUtf8String(
      this->_internal_project_content().data(), static_cast<int>(this->_internal_project_content().length()),
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::SERIALIZE,
      "notepad_users.project.project_content");
    target = stream->WriteStringMaybeAliased(
        4, this->_internal_project_content(), target);
  }
  ...
  // @@protoc_insertion_point(serialize_to_array_end:notepad_users.project)
  return target;
}

size_t project::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:notepad_users.project)
  size_t total_size = 0;
  ...
  if (!this->_internal_project_content().empty()) {
    total_size += 1 +
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::StringSize(
        this->_internal_project_content());
  }
...
void project::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:notepad_users.project)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (!from._internal_project_content().empty()) {
    _this->_internal_set_project_content(from._internal_project_content());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:notepad_users.project)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
void project::InternalSwap(project* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr::InternalSwap(
      &_impl_.project_content_, lhs_arena,
      &other->_impl_.project_content_, rhs_arena
  );
...
project_list::project_list(::PROTOBUF_NAMESPACE_ID::Arena* arena,
  ...
  : ::PROTOBUF_NAMESPACE_ID::Message(arena, is_message_owned) {
  SharedCtor(arena, is_message_owned);
  // @@protoc_insertion_point(arena_constructor:notepad_users.project_list)
}
project_list::project_list(const project_list& from)
  ...
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  // @@protoc_insertion_point(copy_constructor:notepad_users.project_list)
}
...
project_list::~project_list() {
  // @@protoc_insertion_point(destructor:notepad_users.project_list)
  if (auto *arena = _internal_metadata_.DeleteReturnArena<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>()) {
  (void)arena;
    return;
  }
...
// @@protoc_insertion_point(message_clear_start:notepad_users.project_list)
  uint32_t cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
uint8_t* project_list::_InternalSerialize(
    uint8_t* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
  // @@protoc_insertion_point(serialize_to_array_start:notepad_users.project_list)
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_to_array_end:notepad_users.project_list)
  return target;
}

size_t project_list::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:notepad_users.project_list)
  size_t total_size = 0;
...
void project_list::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  // @@protoc_insertion_point(class_specific_merge_from_start:notepad_users.project_list)
  GOOGLE_DCHECK_NE(&from, _this);
  uint32_t cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:notepad_users.project_list)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::notepad_users::project*
Arena::CreateMaybeMessage< ::notepad_users::project >(Arena* arena) {
  return Arena::CreateMessageInternal< ::notepad_users::project >(arena);
}
template<> PROTOBUF_NOINLINE ::notepad_users::project_list*
Arena::CreateMaybeMessage< ::notepad_users::project_list >(Arena* arena) {
  return Arena::CreateMessageInternal< ::notepad_users::project_list >(arena);
}

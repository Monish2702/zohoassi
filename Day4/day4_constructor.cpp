...
private:
    ...
    { // parameterize constructor initializing the top,left to zero
        left = new int(0);
        top = new int(0);
        width = new int(w);
        height = new int(h);
    ...
    { // parameterize constructor initializing all the values
        left = new int(l);
        top = new int(t);
        width = new int(w);
        height = new int(h);
    ...
    { // parameterize constructor initializing all the values & round off
